...
public class AnimalServiceImpTest {
    ...
    public void testGetAll() {
        List<AnimalDao> expectedAnimalList = new ArrayList<>();
    ...
    public void testGetByName_whenAnimalDoesNotExist() {
        ...
        assertThrows(AnimalNotFoundException.class, () -> animalServiceImp.get("Bigotes"));
    }
    ...
    public void testGetByName_whenAnimalExist() {
        ...
        Animal actualAnimal = animalServiceImp.get("Bigotes");
    ...
    public void testDelete_whenAnimalDoesNotExist() {
        ...
        assertThrows(AnimalNotFoundException.class, () -> animalServiceImp.delete("Bigotes"));
    }
